...
var FX_RELATED_LABELS = {
  ...
  USDJPY: ["Forex Major Pairs"],
  USDCHF: ["Forex Major Pairs"],
  USDCAD: ["Forex Major Pairs"],
  AUDUSD: ["Forex Major Pairs"],
  NZDUSD: ["Forex Major Pairs"],
  EURJPY: ["Forex Minor Pairs"],
  GBPJPY: ["Forex Minor Pairs"],
  EURGBP: ["Forex Minor Pairs"],
  CADJPY: ["Forex Minor Pairs"],
  NZDJPY: ["Forex Minor Pairs"],
  BTCUSD: ["Bitcoin (BTC)"],
